...
exports.createServerPreUploadItemActionRouteHandler = void 0;
const extract_1 = require("../../utils/extract");
const error_1 = require("../error");
const createServerPreUploadItemActionRouteHandler = (group) => async ({ req, res, next, localize, ctx }) => {
...
exports.createServerPreUploadItemActionRouteHandler = createServerPreUploadItemActionRouteHandler;
